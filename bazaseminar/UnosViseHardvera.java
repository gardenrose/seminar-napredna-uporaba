...
public class UnosViseHardvera {
	...
	private final JLabel lblKolicina = new JLabel("Kolicina :");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UnosViseHardvera window = new UnosViseHardvera();
	...
	public void initialize() {
		...
		frame.setBounds(100, 100, 281, 468);
		...
		lblKolicina.setBounds(10, 332, 88, 14);

		frame.getContentPane().add(lblKolicina);
		textField.setColumns(10);
		textField.setBounds(95, 329, 160, 20);
		...
		class OK_click implements ActionListener {
			public void actionPerformed(ActionEvent e) {
				if (txt1.getText().equals("''") || txt2.getText().equals("''") || txt3.getText().equals("")
						|| txt4.getText().equals("") || textField.getText().equals("")) {
